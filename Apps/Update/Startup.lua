...
paintutils.drawFilledBox(Screen.Width/2-9,Screen.Height/2-1,Screen.Width/2+9,Screen.Height/2+2,128)
term.setCursorPos(Screen.Width/2-7,Screen.Height/2)
term.setTextColor(1)
term.setBackgroundColor(128)
print("No update found")
term.setCursorPos(Screen.Width/2-6,Screen.Height/2+1)
print("Force update?")
term.setCursorPos(Screen.Width/2-7,Screen.Height/2+2)
print("Yes")
term.setCursorPos(Screen.Width/2+6,Screen.Height/2+2)
print("No")
local update=true
while update do
local tEvent={os.pullEventRaw()}
if tEvent[1]=="mouse_click" then
if tEvent[4]>=Screen.Height/2-1 and tEvent[4]<=Screen.Height/2+2 then
if tEvent[4]==Screen.Height/2+2 then
if tEvent[3]>=Screen.Width/2-8 and tEvent[3]<=Screen.Width/2-4 then
force=true
update=false
...
for i=1,5 do
paintutils.drawImage(img,Screen.Width/2-4,Screen.Height/2+1)
paintutils.drawPixel(Screen.Width/2-4+2*(i-1),Screen.Height/2+1,1)
os.sleep(.085)
end
paintutils.drawImage(img,Screen.Width/2-4,Screen.Height/2+1)
end
